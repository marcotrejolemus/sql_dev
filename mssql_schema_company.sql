...
CREATE TABLE "producto" (
  ...
  "descripcion_departament" varchar (101)
);
...
CREATE TABLE "cliente" (
  ...
  "descripcion_sector" varchar (101)
);
...
CREATE TABLE "vendedor" (
  ...
  "descripcion_supervisor" varchar (101)
);
